...
<!-- Header -->
  <nav class="navbar navbar-expand-md bg-white navbar-white sticky-top">
    ...
    <!--Logo-->
    <a class="navbar-brand" href="#"><img src="assets/img/logo.jpg" width="45px"></a>
      ...
      <div class="collapse navbar-collapse" id="collapsibleNavbar">
        <ul class="navbar-nav">
          ...
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle " href="#" id="navbardrop" data-toggle="dropdown">เกี่ยวกับโรงเรียน</a> <!--About-->
          ...
          <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" href="#" id="navbardrop" data-toggle="dropdown">เพิ่มเติม</a> <!--More-->
              <div class="dropdown-menu">
