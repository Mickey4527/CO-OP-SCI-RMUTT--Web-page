	...
	<div class="bg-body-3">
		<div class="container">
			<div class="row">
				...
				<div class="col-12 d-flex justify-content-center align-items-center mt-2"> 	
					<sup><small class="text-muted">Desgin by <a class="text-dark-500" href="https://github.com/Mickey4527">Saran&nbsp;</a>&amp;&nbsp;<span class="text-dark-500">Pornkamon&nbsp;</span></small>|</sup>
					<sup><small class="text-muted">&nbsp;Visual by <a class="text-dark-500" href="https://www.freepik.com/">Freepik</a></small></sup>
				</div>
			</div>
      	</div>
	</div>
